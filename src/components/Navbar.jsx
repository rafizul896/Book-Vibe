...
const Navbar = () => {
    return (
        <div className="md:navbar shadow-md py-5">
            <div className="md:navbar-start flex flex-row-reverse items-center justify-between md:block">
                <div className="dropdown">
                    <div tabIndex={0} role="button" className="lg:hidden">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
                    </div>
                    <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 -ml-40 md:ml-0 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
